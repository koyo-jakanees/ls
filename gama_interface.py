...
class GamaInterface(object):
    ...
    def __init__(
        self, dimension=2, probability=0.95, stdev_angle=3, stdev_dist=3, stdev_dist1=3
    ):
        ...
        self.points = []
        self.observations = []
        gama_path = QSettings().value(
            "SurveyingCalculation/gama_path", config.gama_path
        )
    ...
    def adjust(self):
        ...
        points_observations.setAttribute(
            "angle-stdev", str(math.sqrt(self.stdev_angle * 2))
        )
                ...
                if self.dimension == 2:
                    ...
                    if o.d is not None and o.v is not None:
                        ...
                        if o.d.mode == "SD":
                            ...
                            tmp.setAttribute(
                                "val", str(o.d.d / math.tan(o.v.get_angle()) + ih - th)
                            )
                            tmp.setAttribute(
                                "stdev",
                                str(
